...
Which factor(s) contribute the most to the risk of heart disease?
...
## Logistic Regression (Danny Kim, Jared Feliprada)
...
From the results of our final model fit on the full data set, we can see the most significant predictors are Sex, ChestPainType, Cholesterol, FastingBS, and ExerciseAngina, which have the smallest p values among all the predictors. Among these, ChestPainTypeNAP appears to be the most statistically significant predictor, as it has the smallest p value overall.
